...
# Open the latest container signature file {#open-the-latest-container-signature-file}
...
The Container Signature File

—-

# How DROID Identifies Container-based File Formats {#how-droid-identifies-container-based-file-formats}
...
# Container signatures in the PRONOM database {#container-signatures-in-the-pronom-database}
...
# Container Signature File Structure {#container-signature-file-structure}
...
# File Format Mappings {#file-format-mappings}
...
# Container Signature Structures \- Overview {#container-signature-structures---overview}
...
# Container Signature Structures \- Files {#container-signature-structures---files}
...
# Container Signature Structures \- Sequences {#container-signature-structures---sequences}
...
# Container Signature Syntax {#container-signature-syntax}
