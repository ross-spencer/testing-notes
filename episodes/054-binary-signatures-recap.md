...
# Binary Signature File Format Identification Recap {#binary-signature-file-format-identification-recap}
...
![A screenshot of the file 'Dynamite Dan 2.tzx' as viewed in a Hex Editor. The image highlights the first 10 bytes of the file, which correspond with the data described by the specification in the table also seen on this slide.][image24]

—-

Identification based on specification example:
Signature: **5A5854617065211A01**
**![A screenshot of the file 'Dynamite Dan 2.tzx' as viewed in a Hex Editor. The image highlights the first 10 bytes of the file. This is the same image as shown on the previous slide.][image24]**
...
![Screenshot of a text file that says "A lovely file format"][image25]![Screenshot the same text file in a hex editor showing its hexadecimal encoding. The bytes are: "41 20 6C 6F 76 64 6C 79 20 66 69 6C 65 20 66 6F 72 6D 61 74"][image26]
