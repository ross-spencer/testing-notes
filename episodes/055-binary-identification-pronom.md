...
# Binary Signature File Format Identification {#binary-signature-file-format-identification}
...
# Binary Signature File Format Identification example \- ZIP {#binary-signature-file-format-identification-example---zip}
